...
if ( $attachment_ids ) {
	...
	<div class="thumbnails"><?php
		...
		foreach ( $attachment_ids as $attachment_id ) {
			...
			echo apply_filters( 'woocommerce_single_product_image_thumbnail_html', sprintf( '<a href="%s" class="%s" title="%s"  rel="prettyPhoto">%s</a>', $image_link, $image_class, $image_title, $image ), $attachment_id, $post->ID, $image_class );
