...
?>
<div class="grid_9">
    <h1 class="dashboard">Edit Feedback</h1>
    </div><div class="clear">
    </div><div id="portlets">
<?
$id = mysql_real_escape_string($_GET['id']);
$rec = mysql_query("SELECT * FROM feedback where id = '$id'") or die(mysql_error());
...
$query = sprintf("UPDATE feedback SET text='$text' WHERE id = '$id'");
...
for($i=0;$i<$count;$i++){
$del_id = $checkbox[$i];
$sql = "DELETE FROM feedback where  id='$del_id' " or die(mysql_error());
...
<div class="grid_9">
    <h1 class="dashboard">Feedback</h1>
    </div>
<div class="clear">
    </div>
    <!--  TITLE END  -->
    ...
    <div id="portlets">
<?PHP
$tbl_name="feedback";		//your table name
	...
	*/
	...
	$targetpage = "feedback.php"; 	//your file name  (the name of this file)
...
<td class=\"td-8\"><a href='feedback.php?act=editcom&id=$datas[id]'><img src=\"images/icons/edit.gif\" alt=\"edit\" title=\"Edit Feedback\"/></a></td>
