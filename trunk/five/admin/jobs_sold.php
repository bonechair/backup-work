...
<div class="grid_16" id="content">
   <div class="grid_9">
<h1 class="dashboard">Jobs Sold</h1>
    </div>
    <div class="clear">
    </div>
<div class="lang">
    
    <h3>This is where you can see all the jobs that have been sold.</h3></div>
    <div class="clear">
    </div>
    <div id="portlets">
<?PHP
...
for($i=0;$i<$count;$i++){
$del_id = $checkbox[$i];
$sql = "DELETE FROM jobs_sold where  id='$del_id' " or die(mysql_error());
$result = mysql_query($sql);
}
}
if(!mysql_query) {
echo "<p class=\"info\" id=\"error\"><span class=\"info_inner\">Job could not be deleted</span></p>";
}else{ echo "<p class=\"info\" id=\"success\"><span class=\"info_inner\">Job deleted Successfully</span></p>";
}
}
$tbl_name="jobs_sold";		//your table name
	...
	*/
	...
	$targetpage = "jobs_bought.php"; 	//your file name  (the name of this file)
...
<th class=\"th-2\">Job Desc</th>
<th class=\"th-2\">Seller</th>
<th class=\"th-3\">Buyer</th>
<th class=\"th-3\">Seller Accepted</th>
<th class=\"th-3\">Feedback Left</th>
<th class=\"th-3\">Date</th>
<th class=\"th-7\">Delete</th></tr>";
while($datas=mysql_fetch_array($result)){
echo "<tr>
<td class=\"td-1\">$datas[job_id]</td>
<td class=\"td-2\">$datas[willdo]</td>
<td class=\"td-2\">$datas[username]</td>
<td class=\"td-3\">$datas[buyer_username]</td>
<td class=\"td-3\">$datas[accepted]</td>
<td class=\"td-3\">$datas[feedback_left]</td>
