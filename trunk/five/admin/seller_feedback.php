...
?>
<div class="grid_9">
    <h1 class="dashboard">Edit Seller Feedback</h1>
    </div><div class="clear">
    </div><div id="portlets">
<?
$id = mysql_real_escape_string($_GET['id']);
$rec = mysql_query("SELECT * FROM seller_feedback where id = '$id'") or die(mysql_error());
...
$query = sprintf("UPDATE seller_feedback SET text='$text' WHERE id = '$id'");
...
<META HTTP-EQUIV = 'Refresh' Content = '0; URL =seller_feedback.php'>";
}
}
}
...
for($i=0;$i<$count;$i++){
$del_id = $checkbox[$i];
$sql = "DELETE FROM seller_feedback where  id='$del_id' " or die(mysql_error());
...
<META HTTP-EQUIV = 'Refresh' Content = '1; URL =seller_feedback.php'>";
}
}
...
<div class="grid_9">
<h1 class="dashboard">Sellers Feedback</h1>
    </div>
<div class="clear">
    </div>
<div class="lang">
    
    <h3>This is where you can see all the feedback left by members that have sold jobs.</h3></div>
<div class="clear">
    </div>
    <!--  TITLE END  -->
    <!-- #PORTLETS START -->
    <div id="portlets">
<?PHP
$tbl_name="seller_feedback";		//your table name
	...
	*/
	...
	$targetpage = "seller_feedback.php"; 	//your file name  (the name of this file)
...
<td class=\"td-8\"><a href='seller_feedback.php?act=editcom&id=$datas[id]'><img src=\"images/icons/edit.gif\" alt=\"edit\" title=\"Edit Feedback\"/></a></td>
