...
<div class="grid_16" id="content">
   <div class="grid_9">
    <h1 class="dashboard">Jobs Bought</h1>
    </div>
    <div class="clear">
    </div>
    <div id="portlets">
...
for($i=0;$i<$count;$i++){
$del_id = $checkbox[$i];
$sql = "DELETE FROM jobs_bought where  id='$del_id' " or die(mysql_error());
...
$tbl_name="jobs_bought";		//your table name
...
<th class=\"th-2\">Buyer</th>
<th class=\"th-3\">seller</th>
