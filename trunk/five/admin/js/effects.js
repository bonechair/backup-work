...
if ( $(".more1").length > 0 ) {
		$("#tabs .more1").click(function() {
			$("#hidden_submenu1").slideToggle("fast");
			$(this).toggleClass("current"); return false;
		});
}
if ( $(".more2").length > 0 ) {
		$("#tabs .more2").click(function() {
			$("#hidden_submenu2").slideToggle("fast");
			$(this).toggleClass("current"); return false;
		});
}
if ( $(".more3").length > 0 ) {
		$("#tabs .more3").click(function() {
			$("#hidden_submenu3").slideToggle("fast");
			$(this).toggleClass("current"); return false;
		});
}
if ( $(".more4").length > 0 ) {
		$("#tabs .more4").click(function() {
			$("#hidden_submenu4").slideToggle("fast");
			$(this).toggleClass("current"); return false;
		});
}
if ( $(".more5").length > 0 ) {
		$("#tabs .more5").click(function() {
			$("#hidden_submenu5").slideToggle("fast");
			$(this).toggleClass("current"); return false;
		});
}
if ( $(".more6").length > 0 ) {
		$("#tabs .more6").click(function() {
			$("#hidden_submenu6").slideToggle("fast");
			$(this).toggleClass("current"); return false;
		});
}
