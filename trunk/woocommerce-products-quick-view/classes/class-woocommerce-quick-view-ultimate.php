...
class WC_Quick_View_Ultimate
{
	...
	public function add_quick_view_ultimate_hover_each_products(){
		...
		$quick_view_ultimate_button .= '<div class="quick_view_ultimate_container" position="'.$quick_view_ultimate_on_hover_bt_alink.'"><div class="quick_view_ultimate_content"><span id="'.get_the_ID().'" data-link="'.get_permalink().'" class="'.$class.'"> </span></div></div>';
